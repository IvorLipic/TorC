...
See **[EXAMPLES.md](EXAMPLES.md)** for end-to-end training scripts, including MNIST MLP and
MNIST CNN.
...
- End-to-end examples: MNIST MLP (`examples/mnist_mlp/mnist_mlp.cpp`) and MNIST CNN
