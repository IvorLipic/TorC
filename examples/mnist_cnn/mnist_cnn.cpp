// examples/mnist_cnn/mnist_cnn.cpp
#include "torc/nn.hpp"
...
int main(int argc, char** argv) {
    try {
        ...
        std::cout << "Step 5.13 - End-to-end CNN on MNIST\n";
        ...
        std::ofstream loss_file("examples/mnist_cnn/loss_history.csv");
        loss_file << "epoch,loss\n";
        std::ofstream acc_file("examples/mnist_cnn/per_class_accuracy.csv");
        acc_file << "epoch";
